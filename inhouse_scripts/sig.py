...
def plot_png(sample_name, sig_names, weights, nonzero_exposures, mtype, sample_plot, basis_plot, reconstruction_plot, statistics):
    '''
...
def plot_decomposition(sample_DF, sample_name, sigDatabases_DF, sig_names, weights, nonzero_exposures, mtype):
    ...
    img = plot_png(sample_name, sig_names, weights, nonzero_exposures, mtype, sample_plot, basis_plot, reconstruction_plot, statistics)
...
def sample_decomposition(sample, signatures=None, mtype="", genome_build="GRCh37", add_penalty=0.05, remove_penalty=0.01, mutation_context=None, connected_sigs=True, make_decomposition_plots=True, originalProcessAvg=None):
    ...
    img = plot_decomposition(sample_DF, sample_name, sigDatabases_DF[basis_cols], basis_names, weights, nonzero_exposures, mtype)
...
def single_decomposition(vcf_path, output=None, ref='GRCh37', sig_database="default", exome=False):
    ...
    img = plot_decomposition(sample_DF, sample_name, sigDatabases_DF, basis_names, weights, nonzero_exposures, mtype)
